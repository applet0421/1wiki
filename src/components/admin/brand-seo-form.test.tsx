...
const initial = { siteName: "1Wiki", alternateNames: ["1wiki.org"], assets: { icon48: "/brand/icon-48.png", logo: "/brand/logo", defaultOg: "/brand/og-default" }, assetSources: { icon48SourceUrl: "", logoSourceUrl: "", defaultOgSourceUrl: "" }, locales: { "zh-tw": { homeTitle: "中文", homeDescription: "摘要", ogTitle: "中文", ogDescription: "摘要" }, en: { homeTitle: "English", homeDescription: "Summary", ogTitle: "English", ogDescription: "Summary" }, ja: { homeTitle: "日本語", homeDescription: "概要", ogTitle: "日本語", ogDescription: "概要" } } };
