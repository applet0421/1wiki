...
const zhTwDictionary = {
  ...
  author: { eyebrow: "作者介紹", articles: "作者文章", empty: "目前尚無已發布文章。" },
  category: { eyebrow: "主題分類", emptyTitle: "內容準備中", emptyDescription: "這個分類的教學正在整理，很快就會更新。" },
  article: { home: "首頁", readMore: "閱讀解答 →", updated: "更新於", relatedTitle: "同類別推薦文章", explore: "繼續探索", categoryLink: "前往分類 →" },
  footer: { description: "AI、App、軟體、手機與 3C 的實用教學與疑難解答。", information: "網站資訊", about: "關於我們", contact: "聯絡我們", privacy: "隱私權", terms: "使用條款" },
