...
export async function callOpenAIStructured<T>({ apiKey, model, prompt, fetcher = fetch, parse, jsonSchema, schemaName, systemPrompt = "你是 1Wiki 的繁體中文科技教學編輯。" }: StructuredProviderRequest<T>): Promise<T> {
