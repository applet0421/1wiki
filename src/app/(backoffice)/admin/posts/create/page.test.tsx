...
describe("ArticleCreationPage", () => {
  it("shows the article creation choices with descriptions", () => {
    ...
    expect(screen.getByRole("link", { name: "匯入微信文章" })).toHaveAttribute("href", "/admin/posts/wechat");
    expect(screen.getAllByRole("link").map((link) => link.textContent)).toEqual(["手動新增文章", "開始 AI 選題", "開始 AI 改寫", "匯入微信文章"]);
