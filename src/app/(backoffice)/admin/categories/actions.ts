...
export async function createCategoryAction(formData: FormData) {
  ...
  try { await createCategory(prisma, { locale: localeSchema.parse(String(formData.get("locale") || "")), name, slug: slugifyTitle(String(formData.get("slug") || name)), description: String(formData.get("description") || "") }); }
